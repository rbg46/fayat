...
{
    /// <summary>
    /// Représente le modèle d'une commande à envoyer vers SAP.
    /// </summary>
    public class CommandeSapModel : CommandeAdresseModel
    {
        /// <summary>
        ...
        /// CommandeEnt.FournisseurId => FournisseurEnt.TypeSequence
        /// </summary>
        public string FournisseurTypeSequence { get; set; }
        ...
        /// </summary>
        public List<CommandeLigneSapModel> Lignes { get; set; }
    }
}
