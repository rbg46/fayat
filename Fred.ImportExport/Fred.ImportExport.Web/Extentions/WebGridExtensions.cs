...
namespace Fred.ImportExport.Web.Extentions
{

  /// <summary>
  /// #WebMatrix WebGrid Pager Replacement This class allows you to replace 
  /// the standard pager element of the WebMatrix WebGrid with a new version 
  /// that allows it to be styled with Twitter Bootstrap.
  /// </summary>
  /// <remarks>https://github.com/mdobie/WebGridPagerReplacement </remarks>
