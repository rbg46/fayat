...
namespace Fred.ImportExport.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            IndexViewModel model = await CreateIndexViewModel(userId);
            return View(model);
        }


        /// <summary>
        /// Renvoie l'index en fonction de l'utilisateur
        /// </summary>
        /// <param name="userId">id de l'utilisateur</param>
        /// <returns>index</returns>
        private async Task<IndexViewModel> CreateIndexViewModel(string userId)
        {
