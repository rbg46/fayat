...
namespace Fred.ImportExport.Bootstrapper.Tests
{
    [TestClass]
    public class BootstrapperTests
    {
        ...
        public static void Initialize(TestContext testContext)
        {
            ...
            dependencyInjectionService = DependencyInjectionConfig.HangfireDependencyInjectionService;
        }
        ...
        public void AssertEveryRegistrationCanBeResolved()
        {
            ...
            dependencyInjectionService.RegisterInstance(new Mock<ImportExportContext>());
