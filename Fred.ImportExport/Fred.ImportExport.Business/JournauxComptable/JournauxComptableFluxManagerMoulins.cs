...
{
    public class JournauxComptableFluxManagerMoulins : JournauxComptableFluxManager
    {
        public override string FluxCode => ConfigurationManager.AppSettings["flux:journaux:comptable:moulins"];

        public JournauxComptableFluxManagerMoulins(
