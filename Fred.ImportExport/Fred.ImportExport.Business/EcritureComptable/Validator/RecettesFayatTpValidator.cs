...
{
    /// <summary>
    /// Validator de la famille d'OD Recettes
    /// </summary>
    public class RecettesFayatTpValidator : AbstractValidator<EcritureComptableFayatTpModel>
    {
        /// <summary>
        /// Contructeur
        /// </summary>
        public RecettesFayatTpValidator()
        {
            RuleSet("Recettes", () =>
            {
