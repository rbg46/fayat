...
{
    public class MaterielInternePointeFayatTpValidator : AbstractValidator<EcritureComptableFayatTpModel>
    {
        public MaterielInternePointeFayatTpValidator()
        {
            RuleSet("MaterielInternePointe", () =>
            {
                ...
                RuleFor(x => x.RapportLigneId).NotEmpty().WithMessage(FeatureEcritureComptable.Ecriture_Comptable_Erreur_NumeroLigneDePointage_Obligatoire);
            });
        }
    }
}
