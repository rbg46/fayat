...
{
    /// <summary>
    /// Validator de la famille d'OD Mo Pointé
    /// </summary>
    public class MoPointeFayatTpValidator : AbstractValidator<EcritureComptableFayatTpModel>
    {
        /// <summary>
        /// Construteur
        /// </summary>
        public MoPointeFayatTpValidator()
        {
            RuleSet("MoPointe", () =>
            {
