...
{
    /// <summary>
    /// Validator de la famille d'OD Autre dépense
    /// </summary>
    public class AutreDepenseFayatTpValidator : AbstractValidator<EcritureComptableFayatTpModel>
    {
        /// <summary>
        /// Constructeur
        /// </summary>
        public AutreDepenseFayatTpValidator()
        {
            RuleSet("AutreDepense", () =>
            {
