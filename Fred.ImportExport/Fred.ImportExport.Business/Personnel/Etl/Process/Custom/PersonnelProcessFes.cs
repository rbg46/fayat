...
{
    public class PersonnelProcessFes : AbstractBasePersonnelProcess<PersonnelModel, PersonnelAffectationResult>, IPersonnelEtl
    {
        ...
        public PersonnelProcessFes(IImportPersonnelManager importPersonnelFesManager, IPersonnelManager personnelManager, PersonnelEtlParameter parameter)
        {
        ...
        public override void Build()
        {
            ...
            builder
              .Input(new PersonnelInputFes(parameter))
              .Transform(new PersonnelTransformFes(parameter, importPersonnelFesManager))
