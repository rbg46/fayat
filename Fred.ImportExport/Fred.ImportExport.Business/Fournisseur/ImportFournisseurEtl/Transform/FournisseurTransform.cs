...
namespace Fred.ImportExport.Business.Fournisseur.Etl.Transform
{
  ...
  /// </summary>
  public class FournisseurTransform : IEtlTransform<FournisseurAnaelModel, FournisseurModel>
  {
    /// <summary>
    /// Ctor
    /// </summary>
    /// <param name="paysManager">Gestionnaire FRED des Pays</param>
    public FournisseurTransform(IPaysManager paysManager)
    {
    ...
    public void Execute(IEtlInput<FournisseurAnaelModel> input, ref IEtlResult<FournisseurModel> result)
    {
      if (result == null)
      {
    ...
    private FournisseurModel ConvertToModel(FournisseurAnaelModel f)
    {
