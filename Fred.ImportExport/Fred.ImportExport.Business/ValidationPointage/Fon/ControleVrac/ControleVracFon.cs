...
namespace Fred.ImportExport.Business.ValidationPointage.Fon.ControleVrac
{
    public class ControleVracFon
    {
        ...
        private readonly IControleVracFonHangFireJob controleVracFonHangFireJob;
        private readonly IFluxManager fluxManager;

        public ControleVracFon(IControlePointageProvider controlePointageProvider,
            ...
            IControleVracFonHangFireJob controleVracFonHangFireJob,
        ...
        public ControlePointageResult Execute(int utilisateurId, int lotPointageId, PointageFiltre filtre)
        {
            ...
            if (flux.IsActif)
            {
                BackgroundJob.Enqueue(() => controleVracFonHangFireJob.ControleVracJob(ctrlPointage.ControlePointageId, lotPointageId, utilisateurId, filtre, null));
            }
            else
            {
