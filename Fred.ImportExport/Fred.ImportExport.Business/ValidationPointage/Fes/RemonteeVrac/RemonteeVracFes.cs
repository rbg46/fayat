...
namespace Fred.ImportExport.Business.ValidationPointage
{
    ...
    public class RemonteeVracFes
    {
        ...
        private readonly IRemonteeVracFesHangFireJob remonteeVracFesHangFireJob;
        private readonly ValidationPointageFesLogger logger;

        public RemonteeVracFes(IRemonteeVracProvider remonteeProvider,
            ...
            IRemonteeVracFesHangFireJob remonteeVracFesHangFireJob,
        ...
        public RemonteeVracResult Execute(int utilisateurId, DateTime periode, PointageFiltre filtre)
        {
            ...
            if (flux.IsActif)
            {
                BackgroundJob.Enqueue(() => remonteeVracFesHangFireJob.RemonteeVracJob(remonteeVrac.RemonteeVracId, periode, utilisateurId, filtre, null));
            }
            else
            {
