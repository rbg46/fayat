...
{
    public class ControleVracFesQueryExecutor : IControleVracFesQueryExecutor
    {
        private readonly IControlePointageManager controlePointageManager;
        private readonly IPersonnelManager personnelManager;
        private readonly IControleVracFesQueryBuilder controleVracAnaelQueryBuilder;
        private readonly IValidationPointageFesLogger logger;

        public ControleVracFesQueryExecutor(
            IControlePointageManager controlePointageManager,
            IPersonnelManager personnelManager,
            IControleVracFesQueryBuilder controleVracAnaelQueryBuilder,
            IValidationPointageFesLogger logger)
        {
