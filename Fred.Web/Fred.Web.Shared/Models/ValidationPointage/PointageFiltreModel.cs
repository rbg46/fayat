...
{
  public class PointageFiltreModel
  {
    public PointageFiltreModel()
    {
      this.EtablissementPaieList = new List<EtablissementPaieModel>();
    }
    ...
    /// <summary>
    ///   Obtient ou définit une liste d'établissement de paie
    /// </summary>
    public IEnumerable<EtablissementPaieModel> EtablissementPaieList { get; set; }
