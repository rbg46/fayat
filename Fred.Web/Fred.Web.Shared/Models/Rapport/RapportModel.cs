...
namespace Fred.Web.Models.Rapport
{
  ...
  {
    /// <summary>
    /// Le nombre maximum des majorations dans le cas de fes
    /// </summary>
    ...
    /// </summary>
    public RapportTacheModel[] ListCommentaires { get; set; }
    ...
    /// Obtient ou définit la liste des primes à paramétrer dans le rapport
    /// </summary>
    public CodeMajorationModel[] ListMajorations { get; set; }
