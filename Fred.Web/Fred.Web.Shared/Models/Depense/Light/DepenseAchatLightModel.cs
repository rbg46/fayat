...
namespace Fred.Web.Models
{
    ...
    /// </summary>
    public class DepenseAchatLightModel
    {
        /// <summary>
        ...
        /// </summary>
        public CommandeLigneLightModel CommandeLigne { get; set; }
        ...
        /// </summary>
        public decimal MontantHT => this.Quantite * this.PUHT;
        ...
        /// </summary>
        public UtilisateurLightModel2 AuteurCreation { get; set; } = null;
        ...
        /// </summary>    
        public UtilisateurLightModel2 AuteurVisaReception { get; set; } = null;
