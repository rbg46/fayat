...
namespace Fred.Web.Models.IndemniteDeplacement
{
  ...
  public class IndemniteDeplacementModel
  {
    ...
    {
      get { return CodeDeplacement != null ? CodeDeplacement.Code + " - " + CodeDeplacement.Libelle : string.Empty; }
    }
    ...
    {
      get { return CodeZoneDeplacement != null ? CodeZoneDeplacement.Code + " - " +  CodeZoneDeplacement.Libelle : string.Empty; }
    }
    /// <summary>
