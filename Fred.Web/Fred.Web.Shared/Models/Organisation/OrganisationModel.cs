...
namespace Fred.Web.Models.Organisation
{
    public class OrganisationModel : IReferentialModel
    {
        ...
        /// </summary>
        public OrganisationGeneriqueModel OrganisationGenerique { get; set; }
        ...
        /// <summary>
        /// Obtient ou définit la liste des paramValues d'une organisation.
        /// </summary>
        public List<ParamValueModel> ParamValues { get; set; }
