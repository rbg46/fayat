...
namespace Fred.EntityFramework.Migrations
{
    ...
    [Migration("20200506093343_Fix13984ddIndexUnicityForCodeAndSocieteAndEtablissement")]
    partial class Fix13984ddIndexUnicityForCodeAndSocieteAndEtablissement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fred.Entities.Action.ActionEnt", b =>
                {
                    b.Property<int>("ActionId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("ActionJobId");
                    ...
                    b.ToTable("FRED_ACTION");
                });

            modelBuilder.Entity("Fred.Entities.Action.ActionJobEnt", b =>
                {
                    b.Property<int>("ActionJobId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("ExternalJobName")
                        .IsRequired()
                        .HasMaxLength(20);

                    b.HasKey("ActionJobId");

                    b.ToTable("FRED_ACTION_JOB");
                });

            modelBuilder.Entity("Fred.Entities.Action.ActionStatusEnt", b =>
                {
                    b.Property<int>("ActionStatusId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("FRED_ACTION_STATUS");
                });

            modelBuilder.Entity("Fred.Entities.Action.ActionTypeEnt", b =>
                {
                    b.Property<int>("ActionTypeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Fred.Entities.Commande.ActionCommandeLigneEnt", b =>
                {
                    b.Property<int>("ActionCommandeLigneId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ActionCommandeLigneId");

                    b.HasIndex("ActionCommandeLigneId");

                    b.HasIndex("ActionId");

                    b.HasIndex("CommandeLigneId");

                    b.ToTable("FRED_ACTION_COMMANDE_LIGNE");
                });
            ...
            modelBuilder.Entity("Fred.Entities.Groupe.GroupeEnt", b =>
                {
                    ...
                    b.Property<string>("SystemeInterimaire");
            ...
            modelBuilder.Entity("Fred.Entities.Personnel.Interimaire.ContratInterimaireEnt", b =>
                {
                    ...
                    b.Property<int?>("EtatContratId");

                    b.Property<int?>("FournisseurId");

                    b.Property<string>("FournisseurReferenceExterne");
            ...
            modelBuilder.Entity("Fred.Entities.Personnel.Interimaire.ContratInterimaireImportEnt", b =>
                {
                    ...
                    b.Property<string>("HistoriqueImport")
                        .HasMaxLength(1000);

                    b.Property<long>("TimestampImport")
                        .HasColumnType("bigint");

                    b.HasKey("ImportId");

                    b.HasIndex("ContratInterimaireId");

                    b.ToTable("FRED_CONTRAT_INTERIMAIRE_IMPORT");
                });

            modelBuilder.Entity("Fred.Entities.Personnel.Interimaire.EtatContratInterimaireEnt", b =>
                {
                    b.Property<int>("EtatContratInterimaireId")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("EtatContratInterimaireId");

                    b.ToTable("FRED_ETAT_CONTRAT_INTERIMAIRE");
                });
            ...
            modelBuilder.Entity("Fred.Entities.Personnel.PersonnelEnt", b =>
                {
                    ...
                    b.HasIndex("Nom", "Prenom", "Matricule");
            ...
            modelBuilder.Entity("Fred.Entities.Rapport.RapportEnt", b =>
                {
                    ...
                    b.Property<int>("TypeStatutRapport");
            ...
            modelBuilder.Entity("Fred.Entities.Referential.CodeAbsenceEnt", b =>
                {
                    ...
                    b.Property<bool?>("IsCadre");

                    b.Property<bool?>("IsETAM");

                    b.Property<bool?>("IsOuvrier");
            ...
            modelBuilder.Entity("Fred.Entities.Referential.FournisseurEnt", b =>
                {
                    ...
                    b.Property<bool>("BlocageContratInterimaireManuel")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(false);
                    ...
                    b.Property<string>("ReferenceSystemeInterimaire")
                        .HasMaxLength(150);
            ...
            modelBuilder.Entity("Fred.Entities.Referential.MaterielEnt", b =>
                {
                    ...
                    b.HasIndex("Code", "SocieteId", "EtablissementComptableId")
                        .IsUnique()
                        .HasName("IX_UniqueCodeAndSocieteAndEtablissementComptable")
                        .HasFilter("[Code] IS NOT NULL AND [EtablissementComptableId] IS NOT NULL");
            ...
            modelBuilder.Entity("Fred.Entities.Action.ActionEnt", b =>
                {
                    b.HasOne("Fred.Entities.Action.ActionJobEnt", "ActionJob")
                        .WithMany()
                        .HasForeignKey("ActionJobId");

                    b.HasOne("Fred.Entities.Action.ActionStatusEnt", "ActionStatus")
                        .WithMany()
                        .HasForeignKey("ActionStatusId");

                    b.HasOne("Fred.Entities.Action.ActionTypeEnt", "ActionType")
                        .WithMany()
            ...
            modelBuilder.Entity("Fred.Entities.Commande.ActionCommandeLigneEnt", b =>
                {
                    b.HasOne("Fred.Entities.Action.ActionEnt", "Action")
                        .WithMany()
            ...
            modelBuilder.Entity("Fred.Entities.Personnel.Interimaire.ContratInterimaireEnt", b =>
                {
                    ...
                    b.HasOne("Fred.Entities.Personnel.Interimaire.EtatContratInterimaireEnt", "EtatContrat")
                        .WithMany("ContratInterimaires")
                        .HasForeignKey("EtatContratId");
            ...
            modelBuilder.Entity("Fred.Entities.Personnel.Interimaire.ContratInterimaireImportEnt", b =>
                {
                    b.HasOne("Fred.Entities.Personnel.Interimaire.ContratInterimaireEnt", "ContratInterimaire")
                        .WithMany("ContratInterimaireImports")
