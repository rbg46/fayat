...
using Syncfusion.Mvc.DocIO.Web;
...
namespace SyncFusion.Controllers
{
  public partial class DocIOController : Controller
  {
    ...
    public ActionResult NestedMailMerge(string Group1, string Group2, string Group3, string Button)
    {
      ...
      {
        if (Group2 == "Report")
          return new TemplateResult("Template_Report.doc", "Data\\DocIO", HttpContext.ApplicationInstance.Response);
        else
          return new TemplateResult("Template_Letter.doc", "Data\\DocIO", HttpContext.ApplicationInstance.Response);
      }
      string dataPath = string.Empty;
      if (Group2 == "Report")
        dataPath = "Data\\DocIO\\Template_Report.doc";
      else
        dataPath = "Data\\DocIO\\Template_Letter.doc";
      ...
      if (Group3 == "Explicit")
      {
        ...
        ds.ReadXml("Data\\DocIO\\Employees.xml");
    ...
    private MailMergeDataTable GetMailMergeDataTable()
    {
      ...
      FileStream fs = new FileStream("Data\\DocIO\\Employees.xml", FileMode.Open, FileAccess.Read);
...
//OTHER RESOURCES
//Documentation Forums Knowledge base Support
