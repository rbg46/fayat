...
BEGIN 
  INSERT INTO FRED_PARAM_VALUE ([Value], [DateCreation], [DateModification], [AuteurCreationId], [AuteurModificationId], [OrganisationId], [ParamKeyId]) VALUES ('pointage_Mensuelle_Date_Comp_RZB',getDate(),getDate(),1,1,@OrganisationId,@HiddenInputsId)
