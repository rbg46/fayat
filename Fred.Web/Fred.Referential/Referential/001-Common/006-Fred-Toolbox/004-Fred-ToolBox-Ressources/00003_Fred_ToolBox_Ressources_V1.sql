...
AS   
	...
	DECLARE @TypeRessourceId INT;
	SET @TypeRessourceId = (SELECT TypeRessourceId FROM FRED_TYPE_RESSOURCE WHERE UPPER(FRED_TYPE_RESSOURCE.Libelle) = UPPER('Personnel'))
