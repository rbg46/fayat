...
BEGIN
	...
	and (personnel.DateEntree is null or personnel.DateEntree <= GETUTCDATE())) then CAST(1 AS bit)
	Else CAST(0 AS bit)
	end as IsActif
	...
	and (@IsActif = 0 
		...
		(@IsActif = 1 
			...
			and (personnel.DateEntree is null or personnel.DateEntree <= GETUTCDATE()))))
