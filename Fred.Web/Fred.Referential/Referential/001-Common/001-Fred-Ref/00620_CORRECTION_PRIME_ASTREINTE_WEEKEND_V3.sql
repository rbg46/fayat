...
BEGIN  
	DECLARE @primeIdWeekend INT = (SELECT TOP(1) primeId FROM FRED_PRIME WHERE SocieteId = (SELECT TOP(1) SocieteId FROM FRED_PRIME WHERE PrimeId = @primeId) AND Code LIKE 'ASTRWE');
