-- =======================================================================================================================================
-- Description :	4/ Matricule I_14390497
--					La commande n'existe pas pour le contrat (PersonnelfournisseurSocieteId = 1792) 
--					alors qu'un pointage a été effectué (RapportLigneId = 1345293)
-- =======================================================================================================================================
...
BEGIN TRY
	...
	SET @RapportLigneToUpdate = 1345293;
	...
	INSERT INTO FRED_COMMANDE( 
		...
		'Temp',
		I.CiId,
		'Commande Automatique - 31923 - 351439',
		I.DateDebut,
		I.FournisseurId,
		3,
		0,
	...
	INSERT INTO FRED_COMMANDE_LIGNE ( 
		...
		@CommandeId,
		'Intérim 14390497 DEMBELE Aboubacar',
		18664,
		I.RessourceId,
		1,
		I.Valorisation,
