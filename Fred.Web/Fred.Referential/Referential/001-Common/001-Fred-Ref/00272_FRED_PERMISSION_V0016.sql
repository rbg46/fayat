IF NOT EXISTS(SELECT * FROM FRED_PERMISSION WHERE CODE  ='00148' AND PermissionKey = 'button.show.validationprime.validationprime.index')
BEGIN
	-- Si le code est la permission n'existe pas 
	INSERT INTO FRED_PERMISSION   
	SELECT 'button.show.remonteeprime.validationprime.index',1,'00148','Affichage du bouton ''Valider les primes mensuelles''.',0
END
