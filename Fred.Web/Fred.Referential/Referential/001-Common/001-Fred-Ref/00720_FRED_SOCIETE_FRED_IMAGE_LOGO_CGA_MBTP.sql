-- =======================================================================================================================================
-- Author:		Yannick DEFAY 07/03/2019
--
-- Description:
--      - Ajoute les chemins vers le CGA de MBTP
--
-- =======================================================================================================================================
...
BEGIN TRAN
	...
	-- Société MOULIN BTP
	UPDATE S
    SET CGAFournitureId = (SELECT TOP(1) ImageId FROM FRED_IMAGE WHERE Path = '\medias\app\societe\CGA\MBTP\CGA_FOURNITURES_MBTP.docx'),
	    CGALocationId = (SELECT TOP(1) ImageId FROM FRED_IMAGE WHERE Path = '\medias\app\societe\CGA\MBTP\CGA_LOCATION_MBTP.docx'),
	    CGAPrestationId = (SELECT TOP(1) ImageId FROM FRED_IMAGE WHERE Path = '\medias\app\societe\CGA\MBTP\CGA_PRESTATION_MBTP.docx'),
