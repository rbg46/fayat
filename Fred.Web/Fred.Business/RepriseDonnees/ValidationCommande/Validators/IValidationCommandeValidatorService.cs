...
namespace Fred.Business.RepriseDonnees.ValidationCommande.Validators
{
    ...
    /// </summary>
    public interface IValidationCommandeValidatorService : IService
    {
        /// <summary>
        ...
        ValidationCommandeRulesResult VerifyImportRules(List<RepriseExcelValidationCommande> repriseExcelCommandes, ContextForValidationCommande context);
    }
}
