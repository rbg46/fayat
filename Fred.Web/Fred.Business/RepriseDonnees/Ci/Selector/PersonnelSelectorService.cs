...
namespace Fred.Business.RepriseDonnees.Ci.Selector
{
    ...
    /// </summary>
    public class PersonnelSelectorService : IPersonnelSelectorService
    {
        /// <summary>
        ...
        public PersonnelEnt GetPersonnel(string codeSociete, string matricule, ContextForImportCi context)
        {
