...
namespace Fred.Business.EtatPaie.ControlePointage
{
    ...
    /// </summary>
    public interface IListeHeuresSpecifiquesManager : IManager
    {
        /// <summary>
        ...
        MemoryStream GenerateMemoryStreamListeHeuresSpecifiques(EtatPaieExportModel etatPaieExportModel, List<EtatPaieListeCodeMajorationModel> listePointageMensuel, int userId, string templateFolderPath);
    }
}
