...
namespace Fred.Business.EtatPaie.ControlePointage
{
    ...
    /// </summary>
    public interface IControlePointagesManager : IManager
    {
        /// <summary>
        ...
        MemoryStream GenerateMemoryStreamControlePointages(EtatPaieExportModel etatPaieExportModel, List<PointageMensuelPersonEnt> listePointageMensuel, int userId, string templateFolderPath);
    }
}
