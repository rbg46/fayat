(function () {
    ...
    angular
        ...
        .component('budgetRessourceCreateComponent', {
            templateUrl: '/Areas/Budget/Scripts/components/budget-ressource-create.component.html',
            bindings: {
                resources: '<',
                resolve: '<',
                close: '&',
            ...
            controller: 'budgetRessourceCreateComponentController'
        });

    angular.module('Fred').controller('budgetRessourceCreateComponentController', budgetRessourceCreateComponentController);

    budgetRessourceCreateComponentController.$inject = ['$scope', 'Notify', 'BudgetService', 'ModelStateErrorManager',
        'RessourceManagerService', 'UniteManagerService',
        'CiManagerService', 'ParametrageReferentielEtenduService'];

    function budgetRessourceCreateComponentController($scope,
        Notify,
        BudgetService,
