(function () {
    ...
    angular.module('Fred').service('RapportChangeDetectorService', RapportChangeDetectorService);

    RapportChangeDetectorService.$inject = [];

    function RapportChangeDetectorService() {
