...
namespace Fred.Web.App_Start.Bundles
{
    ...
    /// </summary>
    public class AvancementRecetteBundleFactory : BundleFactory
    {
        public AvancementRecetteBundleFactory(BundleCollection bundles)
          : base(bundles)
        {
            JsBundleName("~/AvancementRecetteBundle.js");
            Js("~/Scripts/expr-eval/dist/bundle.min.js",
                 "~/Areas/Budget/Scripts/AvancementRecette/avancement-recette.controller.js",
            ...
            CssBundleName("~/AvancemenRecettetBundle.css");
