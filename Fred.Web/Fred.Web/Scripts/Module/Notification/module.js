...
angular.module('ui-notification').provider('Notification', function () {
    ...
    this.$get = ["$timeout", "$http", "$compile", "$templateCache", "$rootScope", "$sce", "$q", "$window", function ($timeout, $http, $compile, $templateCache, $rootScope, $sce, $q, $window) {
            ...
            $http.get(args.template, { cache: $templateCache }).success(function (template) {
                ...
                var reposite = function () {
                    ...
                    for (var i = messageElements.length - 1; i >= 0; i--) {
                        ...
                        var top = position ? j === 0 ? position : position + verticalSpacing : startTop;
