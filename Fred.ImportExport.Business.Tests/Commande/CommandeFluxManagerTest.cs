...
namespace Fred.ImportExport.Business.Tests.Commande
{
    ...
    {
        private Mock<IFluxManager> fluxManagerMock = new Mock<IFluxManager>();
        ...
        private Mock<IGroupeRepository> groupeRepositoryMock = new Mock<IGroupeRepository>();
        ...
        public void Initialize()
        {
            ...
            commandeFluxManager = new CommandeFluxManager(
                fluxManagerMock.Object,
        ...
        public async Task EnqueueExportCommandeJobToHangfireAsync_CommandeExistWithAllParam_ShouldReturnResultSuccessAndCallHelper()
        {
            ...
            // Assert
            commandeFluxHelperMock.Verify(h => h.EnqueueJob(It.IsAny<Expression<Action>>()), Times.Once);
        }
        ...
        public async Task ExportCommandeToSap_DefaultCommande_ShouldCallHelper()
        {
            ...
            // Act
            CommandeSapModel result = await commandeFluxManager.ExportCommandeToSapJobAsync(commandeId);

            // Assert
            commandeFluxHelperMock.Verify(h => h.SendJobAsync(It.IsAny<object>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once);
        }
        ...
        public async Task ExportCommandeAvenantToSap_DefaultCommande_ShouldCallHelper()
        {
            ...
            // Act
            CommandeAvenantSapModel result = await commandeFluxManager.ExportCommandeAvenantToSapJobAsync(
                new ExportCommandeAvenantToSapParameter { CommandeId = commandeId, NumeroAvenant = 1 });
        ...
        private void SetMockService()
        {
            ...
            commandeFluxHelperMock
                .Setup(h => h.EnqueueJob(It.IsAny<Expression<Action>>()))
                .Returns(Guid.NewGuid().ToString());

            commandeFluxHelperMock
              .Setup(h => h.SendJobAsync(It.IsAny<object>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
